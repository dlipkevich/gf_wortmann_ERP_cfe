...
Процедура ОбновитьСвойстваЭлементовФормы()
		...
		Если ЭтоМобильныйКлиент Тогда
			...
			Если ГруппаПользовательскиеНастройкиОсновные <> Неопределено Тогда
				...
				Если ГруппаПользовательскиеНастройкиОсновные.ПодчиненныеЭлементы.Найти(ГруппаПользовательскиеНастройкиОсновные.Имя+"1") = Неопределено Тогда
					...
					н = 0;
					Пока н < ГруппаПользовательскиеНастройкиОсновные.ПодчиненныеЭлементы.Количество() Цикл
						ПодчиненныйЭлемент = ГруппаПользовательскиеНастройкиОсновные.ПодчиненныеЭлементы[н];
	...
	Если ЭтоМобильныйКлиент Тогда
		...
		Элементы.Закрыть.ПоложениеВКоманднойПанели = ПоложениеКнопкиВКоманднойПанели.ВКоманднойПанели;
		Элементы.Справка.ПоложениеВКоманднойПанели = ПоложениеКнопкиВКоманднойПанели.ВКоманднойПанели;
	КонецЕсли;
