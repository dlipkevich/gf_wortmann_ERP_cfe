...
Процедура ОтчетТабличныйДокументОбработкаДополнительнойРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("СтандартныеПодсистемы.АнализЖурналаРегистрации") Тогда
		...
		МодульАнализЖурналаРегистрацииКлиент.ФормаОтчетаОбработкаДополнительнойРасшифровки(ЭтотОбъект, Элемент, Расшифровка,
		СтандартнаяОбработка);
	КонецЕсли;
...
// Возвращаемое значение:
//  СвойстваМеню - Таблица значений
//
&НаСервереБезКонтекста
Функция СвойстваМенюИзСтруктурыОтчета()
...
&НаКлиенте
Процедура УточнитьПризнакФормированияОтчета(ПараметрыОбновления)
