...
Функция НайтиКонтрагентаНаСервере(ИНН) Экспорт
	...
	Если Рез.Следующий() Тогда
		Стр = Новый Структура("Код,Наименование,GUID",Рез.Код,Рез.Наименование,СокрЛП(Рез.Ссылка.УникальныйИдентификатор()));
	КонецЕсли;
	Возврат Стр; 
