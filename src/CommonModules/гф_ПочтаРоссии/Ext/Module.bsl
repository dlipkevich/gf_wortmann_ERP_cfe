...
Процедура ЗаписатьАдресПолучателя(ЗаписьЖСОН, Адрес) Экспорт
	...
	ЗаписатьСвойствоИЗначениеВJSON(ЗаписьЖСОН, "address-type-to", "DEFAULT");
	...
	Для Каждого Поле Из СоответствиеПолей Цикл
		...
		Если ЗначениеЗаполнено(ЗначениеСвойства) Тогда
			...
			ЗаписатьСвойствоИЗначениеВJSON(ЗаписьЖСОН, ИмяСвойства, ЗначениеСвойства);
...
//
Процедура ЗаписатьСвойствоИЗначениеВJSON(ЗаписьЖСОН, ИмяСвойства, ЗначениеСвойства) Экспорт
