...
Процедура гф_ЗаполнитьСписокВыбора(ДанныеВыбора, УстановленныйСтатус)
	...
	ДанныеВыбора.Добавить(Перечисления.СтатусыЗаявокНаВозвратТоваровОтКлиентов.гф_УКДСформирован);// Добавлено Галфинд_ДомнышеваКР_19_07_2023
	...
	ДанныеВыбора.Добавить(Перечисления.СтатусыЗаявокНаВозвратТоваровОтКлиентов.гф_ЗаявкаОбработанаВРМК); // Добавлено Галфинд_ДомнышеваКР_30_06_2023
