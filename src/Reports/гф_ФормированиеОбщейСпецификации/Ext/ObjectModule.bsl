...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	//КомпоновщикНастроек.ПользовательскиеНастройки.Элементы.Очистить();//.ЗагрузитьПользовательскиеНастройки(КомпоновщикОтбораНоменклатуры.ПользовательскиеНастройки);
	
	// ++ Галфинд СадомцевСА 09.02.2023 Заменил строку
