...
Процедура гф_ПересчитатьТЧТоварыНаОсновнииКоробов() Экспорт
	...
	КонецЦикла;	
	// #wortmann {
	// Галфинд_Домнышева_26_04_2023 - 26_06_2023
    // добавила в свертку гф_IDКороба (необходимо заполнять ТЧ Товары с учетом УЛ) и СтавкаНДС(26_06_2023)
	ВременнаяТаблицаТовары.Свернуть("Номенклатура,Характеристика,Назначение,Упаковка,гф_РазмерностьОбуви,Цена, гф_IDКороба, СтавкаНДС",
