...
Процедура СкидкаПриИзмененииНаСервере()
	...
	Если Скидка < МинимальноеЗначение Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Скидка = МинимальноеЗначение:" + Скидка);
	КонецЕсли;
	Если Скидка > МаксимальноеЗначение Тогда
		Скидка = МаксимальноеЗначение;
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Скидка = МаксимальноеЗначение:" + Скидка);
	КонецЕсли;
КонецПроцедуры
