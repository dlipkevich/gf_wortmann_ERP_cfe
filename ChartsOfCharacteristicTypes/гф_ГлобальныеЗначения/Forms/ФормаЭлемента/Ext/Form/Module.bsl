...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) 
	...
	КонецЕсли;
	// Галфинд СадомцевСА 19.04.2024 Редактирование этого объекта доступно в документе гф_СпецификацияПокупателя
	// ФормаДокумента, ФормаСписка. Добавил команду Печать - "Печатная форма Счета для Спецификации покупателя"
	Если Объект.Ключ = "гф_ПечатнаяФормаСчетаДляСпецификацииПокупателя" Тогда
