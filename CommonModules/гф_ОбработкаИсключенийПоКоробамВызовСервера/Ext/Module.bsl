...
Процедура ОбработкаУдаления() Экспорт
	...
	|;
	// Галфинд_ДомнышеваКР_12_02_2023
	// СрезПоследних у ВТ ПТУ выполнен не верно, так как "Отгрузил" является измерением РС
	// Выполнена первоначальная свертка по Периоду относительно ПТУ
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|////////////////////////////////////////////////////////////////////////////////
	// ++ Галфинд_ДомнышеваКР_09_02_2024
	// e1cib/data/Задача.ЗадачаИсполнителя?ref=8eabb083fed1320811eec694d4b5dc52
	// ПО может быть несколько из-за чего происходит дублирование строк по товарам
	//|ВЫБРАТЬ
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	// -- Галфинд_ДомнышеваКР_09_02_2024
