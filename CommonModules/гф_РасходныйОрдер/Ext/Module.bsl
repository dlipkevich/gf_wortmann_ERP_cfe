...
Процедура ОтправитьПисьмо(ДокОбъект, ТекстПисьма, ПроведениеДокумента)
	...
	Если Не ПроведениеДокумента Тогда
		...
		СообщениеПочты.Тема = "Создан ЧЕРНОВИК «Планируемая отгрузка» клиенту " + ДокОбъект.Автор + ".";
		...
		//++ Галфинд ЕсиповАВ 24.03.2023
	Иначе 
		СообщениеПочты.Тема = "Создана «Планируемая отгрузка» клиенту " + ДокОбъект.Автор + ".";
