		...
		//Если Не Строка.ОтметкаОбработкиКорректировка Тогда
			...
			Если ДокСсылкаОснованиеКорректировка <> Неопределено Тогда
				...
				Если Не БылоОбращениеКСуществующемуДокументуКорректировка Тогда
					...
					// Добавление свойства, что бы провести документ. Запрет ручного изменения документа, при наличии свойства "ДокументОснование"
					ДокОбъектКорректировка.ДополнительныеСвойства.Вставить("ДокументСозданАвтоматически", Истина);
...
Процедура гф_РасходныйОрдерОтгрузкаПеремещением(Источник, Отказ, РежимПроведения)
	...
	Для Каждого Строка Из ДанныеДокументаРасходныйОрдер Цикл
		...
		Если ДокСсылкаОснованиеКорректировка <> Неопределено Тогда
			...
			// Добавление свойство, что бы провести документ. Запрет ручного изменения документа, при наличии свойства "ДокументОснование"
			ДокОбъектКорректировка.ДополнительныеСвойства.Вставить("ДокументСозданАвтоматически", Истина);
	...
	Иначе
		...
		Для Каждого Строка Из ДанныеДокументаРасходныйОрдер Цикл
			...
			// в строке таблицы "ДанныеДокументаРасходныйОрдер" полученной из Расходного Ордера
			Строка.ОтметкаОбработкиПеремещение = Истина;
			ДокОбъектПеремещение.ДополнительныеСвойства.Вставить("ДокументОснование", Истина);
