...
Функция СформироватьПечатнуюФормуСписокКМ(МассивОбъектов, ОбъектыПечати)
	...
	МакетОбработки = ОбъектыПечати.ПолучитьМакет("гф_СписокКодовМаркировки");
	...
	Запрос.Параметры.Вставить("Имя",МассивОбъектов);
	...
	Для Каждого Стр Из Таб Цикл  
		...
		Для Каждого СтрокаТовараВКоробах Из Стр.гф_ТоварыВКоробах Цикл 
			...
			Для Каждого СтрокаАгрегации Из ОбъектШк.ВложенныеШтрихкоды Цикл 
				...
				Если СтрДлина(СтрокаАгрегации.Штрихкод.ЗначениеШтрихкода) = 35 тогда
					Штрих =Сред(СтрокаАгрегации.Штрихкод.ЗначениеШтрихкода, 5, 14);
				Иначе
					Штрих =Сред(СтрокаАгрегации.Штрихкод.ЗначениеШтрихкода, 5, 13);
				КонецЕсли; 
				...
				ОбластьСтроки.Параметры.Штрихкод = Штрих;
