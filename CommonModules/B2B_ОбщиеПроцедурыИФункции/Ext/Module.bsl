...
Функция ТекстЗапросаОстатковПоСпискуНоменклатуры() Экспорт
	...
	|
	|	ПервыйОтбор.Номенклатура.Артикул +
	|	ВЫБОР
	|		КОГДА ПервыйОтбор.Характеристика <> ЗНАЧЕНИЕ(Справочник.ХарактеристикиНоменклатуры.ПустаяСсылка)
	|		ТОГДА ""/"" + ПервыйОтбор.Характеристика.Наименование
	|		ИНАЧЕ """"
