...
Функция ТекстЗапросаОстатковПоСпискуНоменклатуры() Экспорт
	...
	|
	|ГДЕ
    |	УпаковочныйЛист.гф_Комплектация.Владелец В (&МассивНоменклатуры)
...
Процедура СохранитьНастройкиПодключенияПортал(НастройкиПодключения, ПорталСсылка) Экспорт
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("B2B_НастройкаПодключения", КлючПортала(ПорталСсылка), НастройкиПодключения);	
...
Функция ВосстановитьНастройкиПодключенияПортал(ПорталСсылка) Экспорт
	...
	НастройкиПодключения = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("B2B_НастройкаПодключения", КлючПортала(ПорталСсылка));
