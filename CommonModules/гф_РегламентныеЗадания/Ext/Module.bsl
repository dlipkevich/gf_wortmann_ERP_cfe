...
Процедура гф_КорректировкаНазначений()
	...
	Попытка
		...
		, УровеньЖурналаРегистрации.Информация, Метаданные.Обработки.гф_КорректировкаНазначений);
	...
	Исключение
		...
		, УровеньЖурналаРегистрации.Информация, Метаданные.Обработки.гф_КорректировкаНазначений,,СтрокаСообщения);
	КонецПопытки;
