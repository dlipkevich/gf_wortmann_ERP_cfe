...
Функция ПодготовитьМассивДокументовЗаказНаЭмиссиюКМ()
	...
	Запрос.Текст = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
               ...
               |ГДЕ
			   // Галфинд СадомцевСА 16.08.2023 Исправил "ошибки" СонарКуба: убрал "условие с ИЛИ" из "раздела ГДЕ". добавил раздел "ОБЪЕДИНИТЬ ВСЕ"
               ...
               |		ПО (ОчередьСообщенийИСМП.Документ = Таблица.Ссылка)
               |ГДЕ
			   // Галфинд СадомцевСА 07.08.2023 Исправил "ошибки" СонарКуба: убрал "условие с ИЛИ" из "раздела ГДЕ". добавил раздел "ОБЪЕДИНИТЬ ВСЕ"
			   //|	(Таблица.ДокументОснование.Проведен
			   //|	 ИЛИ Таблица.ДокументОснование ССЫЛКА Документ.ПересортицаТоваров)
