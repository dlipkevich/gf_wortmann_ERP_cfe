...
Процедура ПолучитьДополнительныеСведения(ДанныеНаПечать)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		СтруктураПроверка.Вставить("Имя", NULL);
		ЗаполнитьЗначенияСвойств(СтруктураПроверка, ВыборкаДетальныеЗаписи);
		
		Если Не СтруктураПроверка["Имя"] = NULL И ВыборкаДетальныеЗаписи.Имя = "гф_МотивПоощрения" Тогда
