...
Функция ПолучитьГлобальноеЗначение(Имя, ЗначениеПоУмолчанию = Неопределено, ЗаменитьНеопределеноНаЗначениеПоУмолчанию = ложь) Экспорт
	Возврат _омОбщегоНазначения.ПолучитьГлобальноеЗначение(Имя, ЗначениеПоУмолчанию, ЗаменитьНеопределеноНаЗначениеПоУмолчанию);
КонецФункции

Функция ПолучитьГлобальноеЗначениеМассив(Имя, ЗначениеПоУмолчанию = Неопределено) Экспорт
	Возврат _омОбщегоНазначения.ПолучитьГлобальноеЗначениеМассив(Имя);
КонецФункции

Функция ПолучитьГлобальноеЗначениеСАвторизацией(Имя) Экспорт
	Возврат _омОбщегоНазначения.ПолучитьГлобальноеЗначениеСАвторизацией(Имя);
КонецФункции
...
Процедура ОткрытьФормуВнешнейОбработки(Знач Ссылка, Знач ВладелецФормы, Параметры = Неопределено, ЭтоОтчет = ложь, ИмяФормы = "", пРежимОткрытияОкна = "Независимый") Экспорт
	...
	Если ТипЗнч(Ссылка) = Тип("Строка") Тогда
		пСтрук = _омОбщегоНазначения.СформироватьПараметрыЗапускаВнешнейОбработки(Ссылка);
