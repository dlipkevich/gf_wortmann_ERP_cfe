...
Процедура СкопироватьСвойства_ПолеВвода(НовыйЭлемент, ОпорныйЭлемент) Экспорт
	...
	// Маска, ПараметрыВыбора, КнопкаОчистки, КнопкаРегулирования, КнопкаСпискаВыбора, ФормаВыбора, 
	// ВыборГруппИЭлементов, РасширенноеРедактирование,  - многие из них не обнаружаются
	
	// РежимВыбораИзСписка, РежимВыбораНезаполненного, РежимПароля, СвязиПараметровВыбора, 
	// СвязьПоТипу, СписокВыбора, ТекстРедактирования, 
	// ШиринаСпискаВыбора, МногострочныйРежим, ОбновлениеТекстаРедактирования, ОтметкаНезаполненного, 
	// РазрешитьСоставнойТип, ДоступныеТипы
	// КартинкаКнопкиВыбора, КнопкаВыбора, РедактированиеТекста, ФорматРедактирования, АвтоПереносСтрок, 
	// ВыбиратьТип, КнопкаОткрытия
	// ЦветРамки, МинимальноеЗначение, МаксимальноеЗначение, ВыделенныйТекст (оно обычно не читается), 
	// КонтекстноеМеню (оно не доступно для записи)
