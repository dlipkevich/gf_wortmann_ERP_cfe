...
Процедура гф_ДобавитьКомандыПечати(КомандыПечати)
	...
	Если НЕ ЭтоПартнер Тогда
		// Товарная накладная (ТОРГ-12)
		КомандаПечати = КомандыПечати.Добавить();	// СтрокаТаблицыЗначений
		КомандаПечати.МенеджерПечати = "Обработка.УПДЧерновик.СформироватьПечатнуюФормуУПДСвернутый";
	...
	Если НЕ ЭтоПартнер Тогда
		// Товарная накладная (ТОРГ-12)
		КомандаПечати = КомандыПечати.Добавить();	// СтрокаТаблицыЗначений
		КомандаПечати.МенеджерПечати = "Обработка.УПДЧерновик.СформироватьПечатнуюФормуЗаявкиНаОтгрузкуСНГ";
	...
	Если НЕ ЭтоПартнер Тогда
		// Товарная накладная (ТОРГ-12)
		КомандаПечати = КомандыПечати.Добавить();	// СтрокаТаблицыЗначений
		КомандаПечати.МенеджерПечати = "Обработка.УПДЧерновик.СформироватьПечатнуюФормуЗаявкаНаЭкспрот";
	...
	Если НЕ ЭтоПартнер Тогда
		// Товарная накладная (ТОРГ-12)
		КомандаПечати = КомандыПечати.Добавить();	// СтрокаТаблицыЗначений
		КомандаПечати.МенеджерПечати = "Обработка.УПДЧерновик.СформироватьПечатнуюФормуЗаявкаНаРасходРеализацииСклад";
