...
Процедура СоздатьДокументПриобретенияЛицензии(НайденныйДокумент, Инвойс, ТаблицаИнвойса)
	...
	Для Каждого СтрокаОрганизации Из
		ПланыВидовХарактеристик.гф_ГлобальныеЗначения.гф_ПодразделениеСтатьяДляРоялти Цикл 
		
		Если СтрокаОрганизации.Организация = ДокументОбъект.Организация Тогда
			
			ДокументОбъект.Подразделение	= СтрокаОрганизации.Подразделение;
			СтатьяРасходовРоялти			= СтрокаОрганизации.Статья;
