...
Процедура ЗагрузитьДанныеНаСервере(Инвойс, КаталогАрхива, КаталогЛог, МассивОбработанныхФайлов, МассивИмен) 
	...
	ТаблицаШипЛиста =  СписокXDTOВТаблицу(ДокументХДТОШипЛист.shipping_unit.customer);
	
	ПривестиТаблицуШипЛистаВЧитаемыйВид(ТаблицаШипЛиста);	
...
Процедура ПривестиТаблицуШипЛистаВЧитаемыйВид(ТаблицаШипЛиста)
