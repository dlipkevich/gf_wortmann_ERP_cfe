...
Функция НайтиНоменклатуруПоАртикулуСезону(МассивАртикулов, МассивСезонов)
	...
	|	УНИКАЛЬНЫЙИДЕНТИФИКАТОР(Номенклатура.КоллекцияНоменклатуры) КАК GUIDСезона,
	|	1 КАК Количество
	...
	|
	|ИМЕЮЩИЕ
	|	СУММА(вт_Номенклатура.Количество) > 1
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ГДЕ
	|	вт_АртикулыСезоныДляДублей.Сезон В(&МассивСезонов)
	|	И НЕ вт_АртикулыСезоныДляДублей.Артикул В
	|				(ВЫБРАТЬ
	|					т.Артикул
	|				ИЗ
	|					вт_ДублиАртикуловСУчетомОтбораСезонов КАК т)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
