...
Процедура гф_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)  
	...
	КнопкаПанели = Элементы.Добавить("гф_ОтслеживаемыеОригиналыПервичныхДокументов", Тип("КнопкаФормы"), Элементы.СписокДокументов.КоманднаяПанель);                     
...
Процедура гф_ОтслеживаемыеОригиналыПервичныхДокументов(Команда)     
	...
	ОткрытьФорму("РегистрСведений.гф_ОтслеживаемыеОригиналыПервичныхДокументов.ФормаСписка", ПараметрыОткрытия, ЭтотОбъект);
