...
Функция ПолучитьРасчетнуюСкидкуПоЗаказу(ВидСкидки, Дата, КурсЕвро, СкидкаЗаПредоплату)
	...
	Если	мСезонныйЗаказ
		// Сезонный заказ
		И	мКоличествоДнейОтсрочкиПлатежа <= 0 Тогда
	...
	ИначеЕсли мКоличествоДнейОтсрочкиПлатежа <= 0 Тогда
		// НЕ сезонный заказ
