...
//Функция ПолучитьНомерАдреса(Заказ, АдресДоставки)
//	
...
//		НомерАдреса = ВыборкаДетальныеЗаписи.НомерАдреса;
//		Возврат НомерАдреса;
//	КонецЦикла;
//	
...
Процедура СписокКоробов(Команда)
	...
	ОткрытьФорму("Обработка.гф_ОтгрузкаПоЗаказам.Форма.ФормаНомераУпаковочногоЛиста",ПараметрыФормы,,,,,Оповещение,);
