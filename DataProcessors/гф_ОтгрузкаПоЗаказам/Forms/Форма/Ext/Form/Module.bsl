	...
	Для Каждого СтрокаЗаказы Из ТЗ_Заказы Цикл
		...
		Для Каждого СтрокаУпаковочныйЛистНоменклатура Из СтрокаЗаказы.СписокУпаковочныйЛистИлиНоменклатура Цикл
			...
			Если Объект.ТоварыВКоробках Тогда
				...
				ОбработкаЗаполненияТоваровВКоробах(ВозвратПродолжить, ТЗ_Товары, ТЗ, СтрокаУпаковочныйЛистНоменклатура, СтруктураПереданныхДанных, ОтказЗаписьУпаковочногоЛиста, ОбъектЗаказ,
...
Процедура ОбработкаЗаполненияТоваровВКоробах(ВозвратПродолжить, ТЗ_Товары, ТЗ, СтрокаУпаковочныйЛистНоменклатура, СтруктураПереданныхДанных, ОтказЗаписьУпаковочногоЛиста, ОбъектЗаказ,
	ТЗ_ТоварыВКоробах, ТЗ_ПричиныИзмененияТоварыВКоробах, ТЗКВТ, ТЗПричиныИзменения, ТабКомплектация, СписокКодовСтрокиПоУпаковочнымЛистам)
