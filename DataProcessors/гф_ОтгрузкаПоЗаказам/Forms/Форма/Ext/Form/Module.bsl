	...
	Для Каждого Строка Из Дерево.Строки Цикл
		Для Каждого Строка_Н Из Строка.Строки Цикл
			...
			Для Каждого Строка_Т Из Строка_Н.Строки Цикл
				...
				МассивНаличиеЗаказаСПустымКодомСтроки = ТаблСписокЗаказовСПустымКодомСтроки.НайтиСтроки(Новый Структура("ДокументОтгрузки", Строка_Н.Заказ));
		...
		Для Каждого Строка Из Дерево.Строки Цикл
			Для Каждого Строка_Н Из Строка.Строки Цикл
				...
				Для Каждого СтрокаТЗ Из ТЗ Цикл
					...
					НайденныйОбъект = Строка_Н.Строки.НайтиСтроки(Новый Структура("УпаковочныйЛистСсылка",
