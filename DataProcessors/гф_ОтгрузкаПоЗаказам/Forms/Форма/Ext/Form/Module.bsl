...
Процедура ОтгрузитьНаСервере(Отказ)
	...
	Если ЗначениеЗаполнено(Объект.Склад) И Объект.ТоварыВКоробках Тогда
		...
		ВыполнитьДействиеПоОтгрузкеСУчетомСклада(Отказ);
		
	Иначе
		
		ВыполнитьДействиеПоОтгрузке(Отказ);
...
Процедура ВыполнитьДействиеПоОтгрузке(Отказ)
...
Процедура ВыполнитьДействиеПоОтгрузкеСУчетомСклада(Отказ)
