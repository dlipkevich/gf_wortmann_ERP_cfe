...
Процедура ПолучитьКомментарийИСкидкиДляРТУ(КомментарийРТУ, СкидкаДляРТУ, ДатаДляРТУ, 
	...
	Если ДанныеДляРТУ.Количество() > 0 Тогда
		...
		Для Каждого СтрокаСтруктураПереданныхДанных Из ДанныеДляРТУ Цикл
			...
			Если ЗначениеЗаполнено(СтрокаСтруктураПереданныхДанных.СкидкаДляРТУ) Тогда
	...
	КомментарийДляРТУ(КомментарийРТУ, СкидкаДляРТУ, ДатаДляРТУ, 
	ПроцентРучнойСкидки, СтруктураПереданныхДанных, ПрайсЛистДляРТУ);
...
//
&НаСервере
Процедура КомментарийДляРТУ(КомментарийРТУ, СкидкаДляРТУ, ДатаДляРТУ, 
	ПроцентРучнойСкидки, СтруктураПереданныхДанных, ПрайсЛистДляРТУ)
