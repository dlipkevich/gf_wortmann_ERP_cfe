...
//&НаКлиенте
//Процедура ПослеВыбораДействияПродолжить(СтруктураПараметров, ДействиеИсточник)
//	
//	//Если Не ДействиеИсточник = Неопределено И ДействиеИсточник = "НеУчитыватьЗадолженность" Тогда
//	//	
//	//	Отказ = Ложь;
//	//	
//	//	ОтгрузитьУстановитьСкидки(Отказ);
//	//	
//	//КонецЕсли;
//	
//КонецПроцедуры
