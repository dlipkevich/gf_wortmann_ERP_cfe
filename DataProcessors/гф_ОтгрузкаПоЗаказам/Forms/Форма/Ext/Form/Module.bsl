...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отказ = Не РольДоступна("гф_ИспользованиеОтгрузкиПоЗаказам") ИЛИ Не РольДоступна("ПолныеПрава");
	Если Отказ Тогда
		ТекстСообщения = НСтр("ru = 'У пользователя недостаточно прав, необходимо право ""Использование отгрузки по заказам""!'");
...
//		
//		Элемент.Отгрузить = Отгрузить;
//		
//		Если Не Элемент.ПолучитьЭлементы() = Неопределено Тогда
...
//				УстановитьФлажкиНиже(Строка, Отгрузить);
//			КонецЦикла;
//			
//			
//			//Иначе
...
//				ЭлементРодитель = Элемент.ПолучитьРодителя();
//				//ЭлементРодитель.Отгрузить = Отгрузить;
//				УстановитьФлажкиВыше(ЭлементРодитель, Отгрузить);
//			//Иначе
//			//	Флаг = Ложь;
//			//	ЭлементРодитель = Элемент.ПолучитьРодителя();
//			//	Родитель = ЭлементРодитель.ПолучитьЭлементы();
