...
Процедура УстановитьСтатусыКМЭмитированыПТУ(флСоздатьЗаполнитьОрдера)
...
Процедура ПроверитьУстановитьСтатусыКМЭмитированы(флСоздатьЗаполнитьОрдера = Ложь) Экспорт
	УстановитьСтатусыКМЭмитированыПТУ(флСоздатьЗаполнитьОрдера);
	// ++ Галфинд СадомцевСА 27.11.2023 Добавил параметр флСоздатьЗаполнитьОрдера
	Если флСоздатьЗаполнитьОрдера Тогда
		Возврат;
	КонецЕсли;
