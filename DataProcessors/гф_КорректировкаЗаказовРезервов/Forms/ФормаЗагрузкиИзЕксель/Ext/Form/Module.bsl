...
Процедура ПрочитатьФайл(Команда)
	...
	Для j = СтрокаЗагрузки По RCount Цикл
		...
		Если НЕ ЗначениеЗаполнено(Характеристика) Тогда 
			 СообщитьПользователю("Не найдена характеристика для размера " + ХарактеристикаНаименование);
			 Продолжить;
		КонецЕсли;	
		...
		Если ЗначениеЗаполнено(_Добавить) Тогда
			...
			Исключение
				СообщитьПользователю("Ошибка преобразования в число[" + _Добавить + "] Данные по строке XSL " + Строка(j) + " файла XSL не загружены.");
				Продолжить;
			КонецПопытки;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(_Удалить) Тогда
			...
			Исключение
				СообщитьПользователю("Ошибка преобразования в число[" + _Удалить + "] Данные по строке XSL " + Строка(j) + " файла XSL не загружены.");
				Продолжить;
			КонецПопытки;
		КонецЕсли;
