...
Процедура УправлениеДоступностью()
	...
	Элементы.РезервыРезервыЗагрузитьИзТабличногоДокумента.Доступность = флДанныеЗаказаЗаполнены;
	Элементы.РезервыВКоробахРезервыВКоробахЗагрузитьИзТабличногоДокумента.Доступность = флДанныеЗаказаЗаполнены;
...
Процедура ПослеЗагрузкиИзТабличногоДокументаТовары(Результат)
	...
	Для Каждого ДанныеСтроки Из Результат["Таблица"] Цикл
		...
		Если Не ЗначениеЗаполнено(Номенклатура) Тогда
			Продолжить;
		КонецЕсли;
		Характеристика = НайтиХарактеристику(ДанныеСтроки.Характеристика);
...
&НаСервереБезКонтекста
Функция НайтиХарактеристику(Наименование)
	Если Не ЗначениеЗаполнено(Наименование) Тогда
