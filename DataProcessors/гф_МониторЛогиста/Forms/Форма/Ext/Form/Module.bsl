...
Функция ПолучитьТекстЗапросаПоставка()
	...
	Результат = "ВЫБРАТЬ
	            ...
	            |					ПО ПриобретениеТоваровУслугДополнительныеРеквизиты.Свойство = ДополнительныеРеквизитыИСведения.Ссылка
	            |						И (ДополнительныеРеквизитыИСведения.Имя = ""гф_ПТУПрямаяПоставка"")
	            ...
	            |			ПриобретениеТоваровУслугДополнительныеРеквизиты.Значение) КАК Подзапрос
	            ...
	            |		Подзапрос.ПрямаяПоставка) КАК Подзапрос
