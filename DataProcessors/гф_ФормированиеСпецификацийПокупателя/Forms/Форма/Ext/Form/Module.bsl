...
// Временно до создания справочника статусы заказов	
	//|	И (ЗаказКлиента.гф_СтатусРаботыСЗаказомИ5 = ЗНАЧЕНИЕ(Перечисление.гф_СтатусРаботыСЗаказомИ5.Подтвержден)
	//|			ИЛИ ЗаказКлиента.гф_СтатусРаботыСЗаказомИ5 = ЗНАЧЕНИЕ(Перечисление.гф_СтатусРаботыСЗаказомИ5.ВыпущенаСпецификация))
