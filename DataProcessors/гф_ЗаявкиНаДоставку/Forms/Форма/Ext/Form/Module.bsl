...
Процедура СоздатьИлиЗаполнитьПисьмо(ПисьмоСсылка, Сообщение, МассивСтрок)
	...
	+ ?(ПисьмоHTML, СтрДлина(Письмо.ТекстHTML), СтрДлина(Письмо.Текст)) * Два;
	...
	ОбработатьВложения(Письмо, Сообщение, РазмерыВложений, ПисьмоHTML);
...
//
&НаСервере
Процедура ОбработатьВложения(Письмо, Сообщение, РазмерыВложений, ПисьмоHTML)
