...
Функция СформироватьДокументПР(СтрокиПоТК)
	...
	Для Каждого СтрокаДанных Из СтрокиПоТК Цикл
		...
		ОбластьСтрока.Параметры.ADRESAT = СтрокаДанных.НаименованиеПолное + ";" + СтрокаДанных.КодКлиентаСклад + СтрокаДанных.ДокументОтгрузкиНомер;
		// -- Галфинд Волков 04.12.2023
...
Функция СформироватьДокументDPD(СтрокиПоТК)
	...
	Для Каждого СтрокаДанных Из СтрокиПоТК Цикл
		...
		ОбластьСтрока.Параметры.Длина             = СтрокаДанных.Длина/1000;
		ОбластьСтрока.Параметры.Ширина            = СтрокаДанных.Ширина/1000;
		ОбластьСтрока.Параметры.Высота            = СтрокаДанных.Высота/1000;
		// ++ Галфинд Волков 04.12.2023
		...
		Если СтрокаДанных.ВидНоменклатуры = Справочники.ВидыНоменклатуры.НайтиПоНаименованию("Обувь") И СкладТоварыВКоробах Тогда
			ОбластьСтрока.Параметры.Объем = СтрокаДанных.Длина * СтрокаДанных.Ширина * СтрокаДанных.Высота / 1000000000;
		Иначе
...
Функция СформироватьДокументКонсолидированный(СтрокиПоТК);
	...
	Для Каждого СтрокаДанных Из СтрокиПоТК Цикл
		...
		Если СтрокаДанных.Документ <> Документ Тогда
			...
			СкладТоварыВКоробах = ПолучитьЗначениеРеквизитаСкладаТоварыВКоробках(СтрокаДанных.Склад);
			Если СтрокаДанных.ВидНоменклатуры = Справочники.ВидыНоменклатуры.НайтиПоНаименованию("Обувь") И СкладТоварыВКоробах Тогда
				ОбъемГруза = СтрокаДанных.Длина * СтрокаДанных.Ширина * СтрокаДанных.Высота / 1000000000;
			Иначе
