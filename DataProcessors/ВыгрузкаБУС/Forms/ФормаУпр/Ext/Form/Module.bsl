...
Функция ПолучитьМассивКонтрагентов(МассивСсылок)
	...
	|	ЕСТЬNULL(КонтрагентыB2B_КонтактныеЛицаПоОрганизациям.ОсновноеКонтактноеЛицо, Контрагенты.B2B_ОсновноеКонтактноеЛицо.Ссылка) КАК КонтактноеЛицо,
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Контрагенты.B2B_КонтактныеЛицаПоОрганизациям КАК КонтрагентыB2B_КонтактныеЛицаПоОрганизациям
	|		ПО Контрагенты.Ссылка = КонтрагентыB2B_КонтактныеЛицаПоОрганизациям.Ссылка
	|			И (КонтрагентыB2B_КонтактныеЛицаПоОрганизациям.Организация = &Организация)
	|ГДЕ
...
Функция ПолучитьКонтактныеЛица(Контрагент, Основной = Истина, СкидкиКонтрагента = неопределено)
	...
	B2B_ОсновноеКонтактноеЛицо = Контрагент.B2B_ОсновноеКонтактноеЛицо;     
	Для каждого стр из Контрагент.B2B_КонтактныеЛицаПоОрганизациям Цикл
		Если стр.Организация = Объект.БЦ_Организация и
			НЕ стр.ОсновноеКонтактноеЛицо.Пустая() Тогда
			B2B_ОсновноеКонтактноеЛицо = стр.ОсновноеКонтактноеЛицо;
		КонецЕсли;
	КонецЦикла;

	Запрос.УстановитьПараметр("B2B_ОсновноеКонтактноеЛицо",B2B_ОсновноеКонтактноеЛицо);
