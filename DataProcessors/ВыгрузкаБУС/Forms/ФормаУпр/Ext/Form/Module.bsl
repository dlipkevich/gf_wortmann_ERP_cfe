...
Функция ПолучитьМассивАдресов(Контрагент)
	...
	"ВЫБРАТЬ
	|	Контрагентыгф_АдресаДоставки.Ссылка КАК Ссылка
	|ИЗ
	...
	Пока Рез.Следующий() Цикл
		...
		СтруктураАдрес.XML_ID = СокрЛП(Формат(Рез.Ссылка.GLNНомер, "ЧГ=0"));
		СтруктураАдрес.CODE = Прав(СокрЛП(Рез.Ссылка.НомерАдреса), 5);
		СтруктураАдрес.NAME = Рез.Ссылка.Адрес; 
		
				                                   
		Структура = АдресныйКлассификаторСлужебный.КодыАдресаИКодыКЛАДР(Рез.Ссылка.Адрес).КодыКЛАДР; 
...
Процедура СоздатьСвойства() 
	...
	B2B_КонтрагентВыгружен_Свойство_Wortmann = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Wortmann());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Wortmann(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Wortmann()));
	
	//--------------------
	B2B_КонтрагентВыгружен_Свойство_Jana = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Jana());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Jana(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Jana()));
	
	//--------------------
	B2B_КонтрагентВыгружен_Свойство_ShoeCom = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_ShoeCom());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_ShoeCom(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_ShoeCom()));
	
	//--------------------
	B2B_КонтрагентВыгружен_Свойство_Wendel = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Wendel());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Wendel(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_КонтрагентВыгружен_Wendel()));
	
	//--------------------
	
	B2B_НомерЗаказа_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_НомерЗаказа());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_НомерЗаказа(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_НомерЗаказа()));

	//--------------------
	
	B2B_Загружен_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_Загружен());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_Загружен(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_Загружен()));
	
	B2B_ДатаОтправкиСпец1_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправки_Спец1());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправки_Спец1(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправки_Спец1()));
	
	B2B_ДатаОтправкиСпец2_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправки_Спец2());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправки_Спец2(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправки_Спец2()));
	
	B2B_ДатаОтправкиСчет_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправкиСчет());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправкиСчет(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_ДатаОтправкиСчет()));
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_ИД_КонтактногоЛица(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_ИД_КонтактногоЛица()));
	
	B2B_FilterSizeBox_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_FilterSizeBox());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_FilterSizeBox(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_FilterSizeBox()));
	
	B2B_Size_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_Size());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_Size(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_Size()));
	
	B2B_РазмерныйРяд_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_РазмерныйРяд());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_РазмерныйРяд(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_РазмерныйРяд()));
	
	B2B_Предзаказ_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_Предзаказ());
	...
	СоответствиеСвойств.Вставить(ЭтаОбработка.ИдентификаторСвойства_B2B_Предзаказ(), ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_Предзаказ()));
	
	B2B_Каталог_Свойство  = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(ЭтаОбработка.ИдентификаторСвойства_B2B_Каталог());
