...
//	ТЧОтгружаемыеТовары - ТаблицаЗначений - отгружаемые товары по документу
			...
			Если РазбитьСтроки Тогда
				...
				Если  МассивСтрокУЛКол.Количество() = 0  Тогда
					Для Каждого СтрокаУЛ Из МассивСтрокУЛ Цикл
						КоличествоДобавить = СтрокаУЛ.Количество - НайденУЛ.ВсегоМест;
						СтрокаУЛ.УпаковочныйЛистРодитель = НайденУЛ;
						СтрокаУЛ.Количество = НайденУЛ.ВсегоМест;
