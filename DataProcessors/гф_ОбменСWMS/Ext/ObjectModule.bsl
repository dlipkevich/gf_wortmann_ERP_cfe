...
Функция ТоварыРасход(Документ)
	...
	Если СкладОтправительВПарах И Обувь(Документ) Тогда 	
	...
	ИначеЕсли СкладОтправительВПарах Тогда
		запрос = Новый Запрос(
			"ВЫБРАТЬ
			|	Товары.Номенклатура.Артикул КАК Артикул,
			|	Товары.Характеристика КАК Характеристика,
...
Функция Обувь(Документ)
	...
	Запрос.УстановитьПараметр("Документ", Документ); // ++ Галфинд_Домнышева 2023/02/21
