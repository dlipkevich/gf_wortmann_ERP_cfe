...
//	Возвращено - Булево - Да если вернулся по неправильному составу строк "lines"
...
Процедура ИзменитьСтатусДокумента(Данные, НайденныйДокументОбъект, КоллекцияДокументовXDTO, ФайлОбмена,
	...
	Попытка
		...
		НайденныйДокументОбъект.Записать(РежимЗаписиДокумента.Проведение);// Исправлено на проведение _ДомнышеваКР_19_01_2024
	Исключение
