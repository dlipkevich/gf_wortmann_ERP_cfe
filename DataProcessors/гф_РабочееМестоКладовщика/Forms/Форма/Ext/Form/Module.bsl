...
Функция ПолучитьДанныеЭтикетки(Номенклатура, ДатаИзготовления)
	...
	Запрос.УстановитьПараметр("НацКаталог", Справочники.гф_ВидыЯзыков.НайтиПоНаименованию("Нац. каталог"));
	...
	Для каждого стрТЗ Из тз Цикл
		...
		// ++ Галфинд_ДомнышеваКР_24_04_2023
		Если Лев(стрТЗ["РеквизитИлиСвойство"], 13) = "Производитель" 
			И  ТипАдреса <> Неопределено Тогда 
