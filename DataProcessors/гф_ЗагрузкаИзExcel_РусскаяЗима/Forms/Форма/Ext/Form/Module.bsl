...
Процедура ЗаписатьХарНаимИНомРостовки(Наименование, Стр, ВариантОбъект, Обновление, Отказ) 
	...
	ВариантОбъект.Характеристика = Справочники.ХарактеристикиНоменклатуры.НайтиПоНаименованию(Ростовка, Истина, , Номенклатура);
	...
	Для каждого колонка из Колонки Цикл
		...
		Размер = Справочники.ХарактеристикиНоменклатуры.НайтиПоНаименованию(ИмяРазмера, Истина, , Номенклатура);
	...
	Для каждого Строка Из МассивХарактеристик Цикл
		...
		СтрТабЧасти.Характеристика = Справочники.ХарактеристикиНоменклатуры.НайтиПоНаименованию(Строка.Размер, Истина, , Номенклатура);
