...
Процедура ЗагрузитьЗначенияНоменклатуры(НоменклатураОбъект, Стр, РеквизитыНоменклатуры, Отказ, Обновление = Истина) 
	...
	Если ЗначениеЗаполнено(НоменклатураОбъект.ВидНоменклатуры) Тогда
		...
		НоменклатураОбъект.ОсобенностьУчета = НоменклатураОбъект.ВидНоменклатуры.ОсобенностьУчета; // Галфинд_ДомнышеваКР_06_03_2024
	КонецЕсли;
	// -- Галфинд СадомцевСА 01.11.2023
	...
	//НоменклатураОбъект.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ОбувнаяПродукция; // Галфинд_ДомнышеваКР_06_03_2024
