...
&НаСервере
Функция ГТДИмпортПолучитьДанныеТоварыОбразцыНаСервере(ДанныеЗаполнения, ДокументПартии)
...
Иначе 
	ДанныеТовары	= ГТДИмпортПолучитьДанныеТоварыОбразцыНаСервере(ДанныеЗаполнения, ПоступлениеТоваровУслуг);
