...
Процедура ПроверитьНаличиеКМ(МассивМаркировокТоваров, ДанныеЗаполнения)
	...
	Запрос.УстановитьПараметр("ЗначениеШтрихкода", МассивМаркировокТоваров);
	...
	Если ВБазе.Количество() <> МассивМаркировокТоваров.Количество() Тогда
		 ДанныеЗаполнения.Вставить("МаркировкиЕсть", Ложь);
		 ЗаполнитьПротоколОтсутствующимиВБазе(ВБазе.ВыгрузитьКолонку("ЗначениеШтрихкода"), МассивМаркировокТоваров);
	Иначе
