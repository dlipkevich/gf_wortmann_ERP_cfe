...
Функция CheckSiteUpdateStatusGet(Запрос)
	...
	Попытка
		...
		Задание = РегламентноеЗаданиеУзла(Запрос.ПараметрыЗапроса);
...
Функция РегламентноеЗаданиеУзла(ПараметрыHTTPЗапроса)
	
	ИмяПортала = ПараметрыHTTPЗапроса.Получить("Portal");
