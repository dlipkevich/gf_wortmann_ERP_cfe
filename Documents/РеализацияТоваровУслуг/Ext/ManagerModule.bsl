...
Процедура гф_ДобавитьКомандыПечати(КомандыПечати)
	...
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = "гф_ПечатьЭтикетокРКМизРТУ";
	КомандаПечати.Представление = "Печать этикеток с использованием механизмов РКМ";
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
	КомандаПечати.Порядок = 11;
	КомандаПечати.Обработчик = "гф_ФормированиеПечатныхФормКлиентСервер.гф_СформироватьПечатнуюФормуПечатьЭтикетокРКМизРТУ";
