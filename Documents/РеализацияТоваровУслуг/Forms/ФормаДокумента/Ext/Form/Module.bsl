...
&НаКлиенте
Процедура гф_АдресДоставкиПриИзмененииПосле(Элемент)
	
	гф_УстановитьАдресДоставки();
...
Процедура гф_СоздатьНовыеЭлементы()                                  
	...
	НовоеПоле.УстановитьДействие("ПриИзменении", "гф_АдресДоставкиПриИзмененииПосле");
...
&НаСервере
Процедура гф_УстановитьАдресДоставки()
