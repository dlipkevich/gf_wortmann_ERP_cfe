...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли; 
	// #wortmann {
	// e1cib/data/Задача.ЗадачаИсполнителя?ref=8eabb083fed1320811ee53975318093e
	// Галфинд_Домнышева_15_09_2023
	...
	//КонецЕсли;
	Если РольДоступна("гф_ПодсистемаДебетМенеджмент") Тогда 
		Элементы.ЛимитГруппаСоздать.Видимость = Истина;
	КонецЕсли;
	// } #wortmann
КонецПроцедуры
// } #wortmann 
...
Функция ВернутьТекстЗапросаВДинамическомСписке() 
 ...
 |		гф_УстановкаСнятиеЛимита.Контрагент КАК Юк,
 |		гф_УстановкаСнятиеЛимита.ВидЛимита КАК Юв,
 |		гф_УстановкаСнятиеЛимита.Организация КАК Юо
 //|		МАКСИМУМ(гф_УстановкаСнятиеЛимита.Ссылка) КАК Юс // Галфинд_ДомнышеваКР_14.09.2023
 //|		гф_УстановкаСнятиеЛимита.Контрагент КАК Контрагент,
 //|		гф_УстановкаСнятиеЛимита.Организация КАК Организация,
 //|		гф_УстановкаСнятиеЛимита.ВидЛимита КАК ВидЛимита
 // -- Галфинд_ДомнышеваКР_03_07_2023
 ...
 |		гф_УстановкаСнятиеЛимита.ВидЛимита,
 |		гф_УстановкаСнятиеЛимита.Организация) КАК ВложенныйЗапрос
 |		ЛЕВОЕ СОЕДИНЕНИЕ Документ.гф_УстановкаСнятиеЛимита КАК гф_УстановкаСнятиеЛимита
  // ++ Галфинд_ДомнышеваКР_03_07_2023
  // e1cib/data/Задача.ЗадачаИсполнителя?ref=8eabb083fed1320811ee164bf4a33788
 //|		ПО ВложенныйЗапрос.Юс = гф_УстановкаСнятиеЛимита.Ссылка" ; // Галфинд_ДомнышеваКР_14.09.2023
 ...
 |ПО (ВложенныйЗапрос.Юо = гф_УстановкаСнятиеЛимита.Организация
 |		И ВложенныйЗапрос.Юк = гф_УстановкаСнятиеЛимита.Контрагент
 |		И ВложенныйЗапрос.Юв = гф_УстановкаСнятиеЛимита.ВидЛимита
 |		И ВложенныйЗапрос.Дата = гф_УстановкаСнятиеЛимита.Дата)" ;
 // } #wortmann
