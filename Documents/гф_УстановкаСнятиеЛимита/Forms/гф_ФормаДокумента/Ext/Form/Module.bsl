...
Процедура УстановитьУсловноеОформление()   
	...
	Если Объект.ВидОперации = Перечисления.гф_ВидыОперацийЛимита.СнятиеЛимита Тогда 
		...
		Объект.Сумма = 0;
		Объект.Статус = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.гф_СтатусыЛимитов.Приостановлен");  
	ИначеЕсли Объект.ВидОперации = Перечисления.гф_ВидыОперацийЛимита.УстановкаЛимита Тогда
		Объект.Статус = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.гф_СтатусыЛимитов.ПустаяСсылка");
		Если Объект.Ссылка = ОбщегоНазначения.ПредопределенныйЭлемент("Документ.гф_УстановкаСнятиеЛимита.ПустаяСсылка") Тогда
