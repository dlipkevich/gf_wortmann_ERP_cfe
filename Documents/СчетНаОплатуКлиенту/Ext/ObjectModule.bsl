...
Процедура гф_ЗаполнитьПоРеализацииТоваров(Знач Основание, ДанныеЗаполнения)
	...
	Если ТипЗнч(ДанныеЗаполнения)= Тип("Структура")
		...
		Если ДанныеЗаполнения.Свойство("ЭтапыОплаты") Тогда
			ЭтапыОплатыХЗ = ДанныеЗаполнения.ЭтапыОплаты;
		КонецЕсли;
		// -- Галфинд_ДомнышеваКР_16_04_2024
	Иначе 
	...
	Если ВыборкаПоДокументу.Следующий() Тогда
		...
		Если ЭтапыОплатыХЗ <> Неопределено И ЭтапыГрафикаОплаты.Количество() = 0 Тогда
			
			ЭтапыОплаты = ЭтапыОплатыХЗ.Получить();
			
			ЭтапыГрафикаОплаты.Загрузить(ЭтапыОплаты); 
