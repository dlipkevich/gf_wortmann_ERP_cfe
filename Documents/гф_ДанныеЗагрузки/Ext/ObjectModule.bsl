...
Процедура ПолучитьНаборЗаписейРегистраСтрок()
	...
	|		ИЛИ СтрокиДокумента.Тэг = &Extended_Attribute)"; //++ Галфинд_Домнышева 2023/02/21

	Запрос.УстановитьПараметр("Документ", ЭтотОбъект.Ссылка);
	Запрос.УстановитьПараметр("Extended_Attribute", "Extended_Attribute");//++ Галфинд_Домнышева 2023/02/21
