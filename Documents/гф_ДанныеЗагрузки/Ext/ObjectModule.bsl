...
Процедура ДополнитьСвойствами(ЗначенияСвойств, СтрокаТЧ, Отказ = Ложь)
	...
	Extended_Attribute = ЗагруженныеСтроки.НайтиСтроки(СтруктураОтбора); 
	...
	Для каждого Строка Из Extended_Attribute Цикл 
		...
		СтрокиДопРеквизитов = ЗагруженныеСтроки.НайтиСтроки(СтруктураОтбора);
		...
		Для Каждого Стр Из  СтрокиДопРеквизитов Цикл
			...
			Если Стр.ТЭГ = "QualifierName" Тогда
				...
				Если QualifierName = "LINING" Тогда
					Свойство_LINING = НайтиДополнительныйРеквизитПоИдентификатору("гф_НоменклатураMaterialLining"); 
					Значение = Новый Структура("Свойство, Значение", Свойство_LINING, ЗначениеСвойства);
					ЗначенияСвойств.Добавить(Значение);
					
				ИначеЕсли QualifierName = "UPPER" Тогда
					Свойство_LINING = НайтиДополнительныйРеквизитПоИдентификатору("гф_НоменклатураMaterialSurface"); 
					Значение = Новый Структура("Свойство, Значение", Свойство_LINING, ЗначениеСвойства);
					ЗначенияСвойств.Добавить(Значение);
					
				ИначеЕсли QualifierName = "OUTSOLE"	Тогда
					Свойство_LINING = НайтиДополнительныйРеквизитПоИдентификатору("гф_НоменклатураMaterialBottom"); 
					Значение = Новый Структура("Свойство, Значение", Свойство_LINING, ЗначениеСвойства);
					ЗначенияСвойств.Добавить(Значение);
