...
Процедура гф_ЗаполнитьНазначениеПолучательПоУмолчанию(ВыходныеИзделияСтрокаКоллекции)
	...
	Если Не ЗначениеЗаполнено(ВыходныеИзделияСтрокаКоллекции["Назначение"]) Тогда
		...
		_омОбщегоНазначенияВызовСервера.ПолучитьГлобальноеЗначение("СлужебноеНазначениеДляТоваров");
		ВыходныеИзделияСтрокаКоллекции["Назначение"] = СлужебноеНазначениеДляТоваров;
	КонецЕсли;	
