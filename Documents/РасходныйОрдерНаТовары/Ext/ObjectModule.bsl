...
Процедура гф_ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если РежимЗаписи = РежимЗаписиДокумента.Проведение 
		...
		// #wortmann {
		// Заполнение не требуется при этих условиях
		// e1cib/data/Задача.ЗадачаИсполнителя?ref=8ea8b083fed1320811ee045d251fd110
		// Галфинд Домнышева КР 2023/06/30
		И Не ДополнительныеСвойства.Свойство("гф_ОбменСоСкладом") 
		И НЕ ДополнительныеСвойства.Свойство("ОтключитьКонтрольПриПроведении") 
		// } #wortmann
		Тогда
