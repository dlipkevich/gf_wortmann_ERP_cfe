...
Функция ТекстЗапросаВТ_Номенклатура()
	...
	|	СУММА(ВТ_ПозицииНоменклатуры.Количество) КАК Количество,
	|	СУММА(ВТ_ПозицииНоменклатуры.Количество) КАК КоличествоВКоробе,
	...
	|	ЗаказКлиентаШапка.ДатаОтгрузки КАК ДатаОтгрузки1
