...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.ПроверкаПроведенияПередПечатью	= Ложь;   
	КомандаПечати.Обработчик						= "гф_МенеджерПечати.ПараметрыСпецификацииПоНовойЦене";
...
Функция СформироватьСпецификация(МассивОбъектов, ОбъектыПечати, ПараметрыПечати) Экспорт
	...
	Для Каждого СсылкаНаДокумент Из МассивОбъектов Цикл
		...
		Если ПараметрыПечати.Свойство("гф_Параметры", ПараметрыСпецификацииПоНовойЦене) Тогда
