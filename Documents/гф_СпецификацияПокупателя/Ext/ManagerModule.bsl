...
Функция ДанныеДляПечатиСпецификации(СсылкаНаДокумент, ПараметрыСпецификацииПоНовойЦене = Неопределено)
	...
	Для Каждого СвойствоДоговора Из МассивСвойствДоговора Цикл
		...
		Если СвойствоДоговора.Имя = "гф_ДоговорыКонтрагентовПервичныеДокументыВПарахКоробах" Тогда 
			
			Запрос.Параметры.Вставить("СвойствоДоговоровПервичныеДокументыВПарах", СвойствоДоговора.Ссылка);
...
Функция ТекстЗапроса_ВТШапка()
	...
	|	ISNULL(ДоговорыКонтрагентовПервичныеДокументыВПарах.Значение,ЛОЖЬ) КАК ПервичныеДокументыВПарах
	|ПОМЕСТИТЬ ВТ_Шапка
	|ИЗ
	...
	|			ПРАВОЕ СОЕДИНЕНИЕ Справочник.ДоговорыКонтрагентов.ДополнительныеРеквизиты КАК ДоговорыКонтрагентовПервичныеДокументыВПарах
	|			ПО (ДоговорыКонтрагентовПервичныеДокументыВПарах.Ссылка = ДоговорыКонтрагентов.Ссылка)
	|				И (ДоговорыКонтрагентовПервичныеДокументыВПарах.Свойство = &СвойствоДоговоровПервичныеДокументыВПарах)
...
Функция ТекстЗапросаИтоги()
	...
	Результат = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	            ...
	            |	ВТ_Шапка.ВидЦен КАК ВидЦен,
	            |	ВТ_Шапка.Спецификация КАК Спецификация,
	            |	ВТ_Шапка.ПервичныеДокументыВПарах КАК ПервичныеДокументыВПарах,
	            ...
	            |	ВТ_Шапка.Номер,
	            |	ВТ_Шапка.ПервичныеДокументыВПарах,
	            |	ВТ_Шапка.Организация,
	            |	ВТ_Шапка.Контрагент
	            |;
	            |
