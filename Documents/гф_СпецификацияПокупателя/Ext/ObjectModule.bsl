...
Процедура гф_ОбработкаПроведения(Отказ, РежимПроведения)
	...
	МассивОтличий = ПроверитьСтатусыЗаказов(ПредопределенноеЗначение("Перечисление.гф_СтатусРаботыСЗаказомИ5.Подтвержден"));
	...
	УстановитьСтатусыЗаказов(ПредопределенноеЗначение("Перечисление.гф_СтатусРаботыСЗаказомИ5.ВыпущенаСпецификация"));
...
Процедура гф_ОбработкаУдаленияПроведения(Отказ)
	...
	УстановитьСтатусыЗаказов(ПредопределенноеЗначение("Перечисление.гф_СтатусРаботыСЗаказомИ5.Подтвержден"));
...
Процедура УстановитьСтатусыЗаказов(НовыйСтатусЗаказа)
	...
	Возврат; // Временно пока не создан справочник статусы заказов
