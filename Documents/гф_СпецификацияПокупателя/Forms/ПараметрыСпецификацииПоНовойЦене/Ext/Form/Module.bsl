...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               //|	B2B_w_СкидкиКлиентаПоДоговоруСрезПоследних.Скидка КАК Скидка,
	               //|	B2B_w_СкидкиКлиентаПоДоговоруСрезПоследних.ТипСкидки КАК ТипСкидки,
	               |	гф_ИсторияИзмененияСкидок.Скидка КАК Скидка,
	               |	гф_ИсторияИзмененияСкидок.ВидСкидки КАК ВидСкидки
	               |ПОМЕСТИТЬ ВТ_Скидки
	               |ИЗ
	               //|	РегистрСведений.B2B_w_СкидкиКлиентаПоДоговору.СрезПоследних(&ДатаСкидки, ДоговорКонтрагента = &Договор) КАК B2B_w_СкидкиКлиентаПоДоговоруСрезПоследних,
	               |	РегистрСведений.гф_ИсторияИзмененияСкидок КАК гф_ИсторияИзмененияСкидок
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               |	СУММА(ЕСТЬNULL(ВТ_Скидки.Скидка, 0)) КАК Скидка
	               |ИЗ
	               |	ПланВидовХарактеристик.гф_ГлобальныеЗначения КАК гф_ГлобальныеЗначения
	               ...
	               //|			ПО гф_ГлобальныеЗначенияСписок.Значение = ВТ_Скидки.ТипСкидки
				   |			ПО гф_ГлобальныеЗначенияСписок.Значение = ВТ_Скидки.ВидСкидки
