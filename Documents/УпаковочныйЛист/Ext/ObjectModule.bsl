...
Процедура гф_ПодготовитьАгрегациюКМ()
	...
	Если Не ЗначениеЗаполнено(гф_Агрегация) Тогда
		...
		Если ПакетРезультатов[1].Пустой() Тогда
			...
			ОбъектШтрихкод.гф_АктикулАгрегата = гф_Комплектация;
		Иначе
		...
		Пока ВыборкаНоменклатура.Следующий() Цикл
			...
			КонецЦикла;
		КонецЦикла;
		ОбъектШтрихкод.Количество = ОбъектШтрихкод.ВложенныеШтрихкоды.Количество();
