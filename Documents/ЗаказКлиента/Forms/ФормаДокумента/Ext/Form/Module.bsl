...
Процедура гф_ТоварыВКоробахПриАктивацииСтроки(Элемент)
	...
	гф_ЗаполнитьОтображениеПричинИзмененияНаСервере(ЭлементТекущиеДанные.ВариантКомплектации, ЭлементТекущиеДанные.Скидка);
	// -- Галфинд ВолковЕВ 06.12.2022
КонецПроцедуры

&НаСервере
Процедура гф_ЗаполнитьОтображениеПричинИзмененияНаСервере(ВариантКомплектации, Скидка)
	// ++ Галфинд ВолковЕВ 06.12.2022
