			...
			Если ПотребностьУЛПоВариантам > 0 Тогда
				...
				Для каждого стрТоварыУЛ Из мСтрокТоварыУЛ Цикл
					...
					Для каждого СтрокаОстатков Из мСтрокТаблицыОстатков Цикл
						...
						КонецЕсли;	
						ОстатковДостаточно = 
						СтрокаОстатков["Запас"] - Макс(СтрокаОстатков["Потребность"] - СтрокаОстатков["Обеспечено"], 0) >= 0;
					...
					Иначе 
						Для каждого СтрокаОстатков Из мСтрокТаблицыОстатков Цикл
							СтрокаОстатков["Потребность"] = СтрокаОстатков["Потребность"] + стрТоварыУЛ["КоличествоУпаковок"];
						КонецЦикла;
					КонецЕсли;	
