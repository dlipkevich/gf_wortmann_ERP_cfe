...
Функция гф_ДанныеДокументаДляПроведения(Документ, Регистры, ДопПараметры)
	...
	Если Документ.гф_ОтгрузкаПеремещением Тогда
		ОтразитьРезервПеремещениеПоПолучателя(Запрос, ТекстыЗапроса, Регистры, Документ);
...
Процедура ОтразитьРезервПеремещениеПоПолучателя(Запрос, ТекстыЗапроса, Регистры, Документ)
