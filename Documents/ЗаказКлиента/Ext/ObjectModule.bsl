...
Процедура гф_ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	// #wortmann {
	// #При проведении заполняем типовой реквизит АдресДставки
	// Галфинд Volkov 2023/06/19
	Если ЗначениеЗаполнено(гф_АдресДоставки) Тогда // СадомцевСА 30.01.2024 Добавил условие для перезаполнения Адреса доставки
	...
	Если Не ЗначениеЗаполнено(АдресДоставки)
		...
		ТекстОшибки = НСтр("ru = 'Необходимо заполнить Адрес доставки для печати'");
