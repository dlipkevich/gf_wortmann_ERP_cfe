...
Процедура ЗаполнитьТоварыНаСервере()
	...
	ВременнаяТаблицаТЧТовары.Свернуть("Номенклатура,Характеристика,гф_ДобавленоПоПричине,гф_ПричинаДобавления,Отменено,
		|ПричинаОтмены,ВариантОбеспечения,ВидЦены,ВариантКомплектации,ЦенаКороба,ПроцентРучнойСкидки", "КоличествоУпаковок");
