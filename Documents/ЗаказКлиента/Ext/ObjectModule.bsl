...
Процедура гф_ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не ЗначениеЗаполнено(ЭтотОбъект.АдресДоставки)
	...
	Если Не ЗначениеЗаполнено(ЭтотОбъект.АдресДоставки) Или Не ЭтотОбъект.АдресДоставки = ЭтотОбъект.гф_АдресДоставки.Адрес Тогда
		ЭтотОбъект.АдресДоставки = ЭтотОбъект.гф_АдресДоставки.Адрес;
	КонецЕсли;
	// } #wortmann
