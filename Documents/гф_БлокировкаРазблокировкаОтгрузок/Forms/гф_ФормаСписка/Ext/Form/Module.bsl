...
Процедура УстановитьОтборПоДоговоруКонтрагентаИКонтрагенту()	
	...
	ГруппаОтбораКонтрагент = Список.Отбор.Элементы.Добавить(Тип("ГруппаЭлементовОтбораКомпоновкиДанных"));
	ГруппаОтбораКонтрагент.ТипГруппы = ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ;
	
	ЭлементОтбораКонтрагент =ГруппаОтбораКонтрагент.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	...
	ЭлементОтбораКонтрагент.ПравоеЗначение = ДоговорКонтрагента.Партнер;
