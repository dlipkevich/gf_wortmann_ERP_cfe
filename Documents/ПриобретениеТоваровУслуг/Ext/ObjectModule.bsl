...
Процедура гф_ПересчитатьТЧТоварыНаОсновнииКоробов() Экспорт
    ...
    // добавила в свертку гф_IDКороба (необходимо заполнять ТЧ Товары с учетом УЛ)
	ВременнаяТаблицаТовары.Свернуть("Номенклатура,Характеристика,Назначение,Упаковка,гф_РазмерностьОбуви,Цена, гф_IDКороба",
