...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УпаковочныеЛистыДляПечати.Сортировать("ВариантКомплектации, IDКороба"); // Галфинд_ДомнышеваКР_02_04_2024
...
Функция НайтиШтрикходУпаковкиТоваровИУпаковочныйЛистПоNVE()
	...
	Запрос.Текст = 
		...
		// ++ Галфинд_ДмнышеваКР_08_04_2024
		|
		|УПОРЯДОЧИТЬ ПО
		|	УпаковочныйЛист.гф_Комплектация.Наименование ВОЗР,
		|	УпаковочныйЛист.Код ВОЗР 
		// -- Галфинд_ДмнышеваКР_08_04_2024
		|";
