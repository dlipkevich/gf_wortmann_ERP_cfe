...
&НаСервере
Процедура гф_ИзменитьРеквизитыФормы()
	...
	"гф_СтатусПроверкиКМ", 
	Новый ОписаниеТипов(
	"ПеречислениеСсылка.СтатусыКодовМаркировкиМОТП, ПеречислениеСсылка.СтатусыКодовМаркировкиИСМП"),
	"Объект.ВозвращаемыеТовары",
	"Статус проверки КМ"));
	
	ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы(
	"гф_КлиентЯвляетсяВладельцемКМ", 
	Новый ОписаниеТипов("Булево"),
	"Объект.ВозвращаемыеТовары",
	"Клиент является владельцем КМ"));
	
	ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы(
	"гф_ПроизведенаПроверкаКМ", 
	Новый ОписаниеТипов("Булево"),
	"Объект.ВозвращаемыеТовары",
	"Произведена проверка КМ"));
