...
Процедура гф_ПриОткрытииПосле(Отказ)
	// Галфинд СадомцевСА 24.10.2023 Реализовал "подписание" документов Маркировка товаров ИС МП внешней обработкой
...
Процедура ОчиститьКонстанту()
	Константы.гф_ЗаказНаЭмиссиюКМПодписать.Установить(Неопределено);
КонецПроцедуры
