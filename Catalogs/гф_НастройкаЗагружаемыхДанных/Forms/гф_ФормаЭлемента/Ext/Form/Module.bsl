...
Процедура ТипОбъектаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ИначеЕсли ВыбранноеЗначение = Тип("ДокументСсылка.ЗаказКлиента") 
		ИЛИ ВыбранноеЗначение = Тип("ДокументСсылка.ПриобретениеТоваровУслуг")
		ИЛИ ВыбранноеЗначение = Тип("ДокументСсылка.ПриходныйКассовыйОрдер") 
		ИЛИ ВыбранноеЗначение = Тип("ДокументСсылка.РасходныйКассовыйОрдер") 
		ИЛИ ВыбранноеЗначение = Тип("ДокументСсылка.УстановкаЦенНоменклатуры")   // Галфинд_Домнышева_13_10_22
		ИЛИ ВыбранноеЗначение = Тип("СправочникСсылка.ВариантыКомплектацииНоменклатуры") Тогда    // Галфинд_Домнышева_13_10_22
		СтандартнаяОбработка = Ложь;
