...
Процедура ТипОбъектаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ИначеЕсли ВыбранноеЗначение = Тип("ДокументСсылка.ЗаказКлиента") ИЛИ
		...
		ВыбранноеЗначение = Тип("ДокументСсылка.РасходныйКассовыйОрдер") ИЛИ
		ВыбранноеЗначение = Тип("ДокументСсылка.УстановкаЦенНоменклатуры") ИЛИ  // Галфинд_Домнышева_13_10_22
		ВыбранноеЗначение = Тип("СправочникСсылка.ВариантыКомплектацииНоменклатуры")Тогда    // Галфинд_Домнышева_13_10_22
		СтандартнаяОбработка = Ложь;
