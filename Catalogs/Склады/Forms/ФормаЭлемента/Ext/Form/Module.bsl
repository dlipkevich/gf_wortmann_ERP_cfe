...
Процедура гф_СоздатьНовыеРеквизиты()
	...
	РеквизитФормы_гф_ТоварыВКоробках	= Новый РеквизитФормы("гф_ТоварыВКоробках",
										ОписаниеТиповБулево, , "Товары в коробах", Истина);	
	...
	ДобавляемыеРеквизиты.Добавить(РеквизитФормы_гф_ТоварыВКоробках);
	...
	НовоеПоле = Элементы.Добавить("гф_БезРезерва", ТипПолеФормы,
										Элементы.ОсновноеПраво);
	...
	НовоеПоле = Элементы.Добавить("гф_ТоварыВКоробках", ТипПолеФормы,
										Элементы.ОсновноеПраво);
	
	НовоеПоле.Вид			= ВидПоляФормы.ПолеФлажка;
	НовоеПоле.Видимость		= Истина;
	НовоеПоле.ПутьКДанным	= "Объект.гф_ТоварыВКоробках"; 

	
	НовоеПоле = Элементы.Добавить("гф_АгентскийСклад", Тип("ПолеФормы"), ЭтаФорма.Элементы.ГруппаТипСкладаКолонки);
