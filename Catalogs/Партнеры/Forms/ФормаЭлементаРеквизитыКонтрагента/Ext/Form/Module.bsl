...
Процедура гф_ДобавитьАдрес(Команда) 
	...
	ПараметрыНовогоАдреса = Новый Структура("ЗначенияЗаполнения", ЗначенияЗаполнения);
	
	ОткрытьФорму("Справочник.гф_АдресаДоставки.ФормаОбъекта", ПараметрыНовогоАдреса);
