...
Процедура гф_СоздатьРеквизитыКонтрагента()
	...
	Если Элементы.Найти("гф_ОсновнойКонтрагент") = Неопределено Тогда
		...
		РеквизитФормы_B2B_КонтактныеЛицаПоОрганизациям_Организация	= Новый РеквизитФормы("B2B_КонтактныеЛицаПоОрганизациям_Организация", 
										ОписаниеТиповОрганизации, "B2B_КонтактныеЛицаПоОрганизациям", "Организация", Истина); 
		РеквизитФормы_B2B_КонтактныеЛицаПоОрганизациям_ОсновноеКонтактноеЛицо				= Новый РеквизитФормы("B2B_КонтактныеЛицаПоОрганизациям_ОсновноеКонтактноеЛицо", 
