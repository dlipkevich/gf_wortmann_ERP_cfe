...
Процедура гф_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("гф_ИсторияИзмененияСкидок", ОписаниеТипаТЗ, "",
		"Актуальные скидки"));
    ...
    Для Каждого Колонка Из ТЗ.Колонки Цикл
        ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы(Колонка.Имя, Колонка.ТипЗначения,
