...
Процедура гф_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	НовыйЭлемент  = Элементы.Добавить("гф_Скидкигф_ТипСкидки", ТипПолеФормы, ТаблицаФормы);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;      
	НовыйЭлемент.ПутьКДанным = "Объект.гф_Скидки.гф_ТипСкидки";
	
	НовыйЭлемент  = Элементы.Добавить("гф_Скидкигф_Скидка", ТипПолеФормы, ТаблицаФормы);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;      
	...
	НовыйЭлемент = Элементы.Вставить("гф_РазмерПредоплатыПоЗаказуПокупаетля", ТипПолеФормы,
					Элементы.гф_СтраницаДополнительно);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.гф_РазмерПредоплатыПоЗаказуПокупаетля";
