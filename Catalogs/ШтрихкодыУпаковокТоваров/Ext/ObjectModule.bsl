...
Процедура гф_ПередЗаписью(Отказ)
	...
	Если Не Отказ И Не ПометкаУдаления Тогда
		...
		ЭлементБлокировки.УстановитьЗначение("ТипШтрихкода",      ТипШтрихкода);
		ЭлементБлокировки.УстановитьЗначение("ЗначениеШтрихкода", ЗначениеШтрихкода);
		ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;
		Блокировка.Заблокировать();
		
		Если Не Справочники.ШтрихкодыУпаковокТоваров.ЗначениеШтрихкодаУникально(ЭтотОбъект) Тогда
			
			Отказ = Истина;
			
			ВызватьИсключение "Значение штрихкода " + ЗначениеШтрихкода + " не уникально";
