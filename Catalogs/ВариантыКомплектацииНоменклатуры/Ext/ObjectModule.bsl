...
Процедура ИК_ПриЗаписи(Отказ)
	...
	Если Не Отказ  
		...
		Запрос.Текст = 
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	РегистрСоответствия.ГруппаДоступа КАК ГруппаДоступа,
			|	МАКСИМУМ(РегистрСоответствия.Организация) КАК Организация
			|ПОМЕСТИТЬ ВтРегистрСоответствияГруппДоступа
			|ИЗ
			|	РегистрСведений.гф_СоответствиеОрганизацииГруппеДступаИСписка КАК РегистрСоответствия
			|
			|СГРУППИРОВАТЬ ПО
			|	РегистрСоответствия.ГруппаДоступа
			|;
			|
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			...
			|	РегистрСоответствияГруппДоступа.Организация КАК Организация,
			...
			|
			|		ЛЕВОЕ СОЕДИНЕНИЕ ВтРегистрСоответствияГруппДоступа КАК РегистрСоответствияГруппДоступа
			|			ПО (СправочникНоменклатура.ГруппаДоступа = РегистрСоответствияГруппДоступа.ГруппаДоступа)
		    |
			|ГДЕ
